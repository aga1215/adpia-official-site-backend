package org.adpia.official.domain.threeminutespeech.controller;
...
@RequestMapping("/api/three-minute-speech")
public class ThreeMinuteSpeechController {
	...
	public RecruitPostResponse create(@Valid @RequestBody RecruitPostUpsertRequest req) {
		Actor actor = actorResolver.resolveOrGuest();
		return recruitService.create(RecruitBoardCode.THREE_MIN_SPEECH, req, actor);
	}
