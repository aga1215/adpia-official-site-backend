package org.adpia.official.domain.community.controller;

import jakarta.validation.Valid;
import lombok.RequiredArgsConstructor;
import org.adpia.official.domain.community.CommunityCategory;
...
public class CommunityController {
	...
	private RecruitBoardCode resolveBoardCode(String category) {
		return CommunityCategory.from(category).getBoardCode();
	}
