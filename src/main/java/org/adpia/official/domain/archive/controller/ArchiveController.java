package org.adpia.official.domain.archive.controller;

import jakarta.validation.Valid;
import lombok.RequiredArgsConstructor;
import org.adpia.official.domain.archive.ArchiveCategory;
...
@RequestMapping("/api/archive/{category}")
public class ArchiveController {
	...
	private RecruitBoardCode resolveBoardCode(String category) {
		return ArchiveCategory.from(category).getBoardCode();
	}
